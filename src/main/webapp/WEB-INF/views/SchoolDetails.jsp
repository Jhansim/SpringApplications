...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="generic-container" ng-controller="SchoolController as ctrl">
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">School Registration Form </span></div>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.schools">
                              <td><span ng-bind="u.id"></span></td>
                              <td><span ng-bind="u.name"></span></td>
                              <td><span ng-bind="u.registrationnumber"></span></td>
      ...
      <script src="<c:url value='/static/js/service/school_service.js' />"></script>
      <script src="<c:url value='/static/js/controller/school_controller.js' />"></script>
  </body>
</html>